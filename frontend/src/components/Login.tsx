  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-blue-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-800 font-medium">
                <strong>DEMO DATA ONLY</strong> - Do not enter real credentials.
        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-xl sm:px-10 border border-blue-100">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 space-y-2">
              <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-gray-700">
                  <strong className="text-blue-700">Patient:</strong> patient@demo.com / patient123
                </p>
              </div>
              <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-3">
                <p className="text-sm text-gray-700">
                  <strong className="text-green-700">Doctor:</strong> doctor@demo.com / doctor123
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 text-center">
              <a
                ...
                className="text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors mr-4"
              >

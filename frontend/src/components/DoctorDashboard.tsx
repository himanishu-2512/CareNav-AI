  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mb-4 md:mb-6">
        <h1 className="text-xl sm:text-2xl font-bold mb-3 md:mb-4">Doctor Dashboard</h1>
        
        {/* Quick Action Buttons */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:flex-wrap gap-2 sm:gap-3 mb-4 md:mb-6">
          <button
            onClick={() => setShowAddPatientModal(true)}
            className="px-3 py-2 sm:px-4 bg-blue-600 text-white rounded hover:bg-blue-700 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
          ...
          <button
            ...
            className="px-3 py-2 sm:px-4 bg-green-600 text-white rounded hover:bg-green-700 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <span className="hidden sm:inline">Prescribe Medicine</span>
            <span className="sm:hidden">Prescribe</span>
          </button>
          <button
            onClick={() => window.location.href = '/treatment/planner'}
            className="px-3 py-2 sm:px-4 bg-purple-600 text-white rounded hover:bg-purple-700 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
            </svg>
            <span className="hidden sm:inline">Treatment Planner</span>
            <span className="sm:hidden">Treatment</span>
          </button>
          <button
            onClick={() => window.location.href = '/adherence/dashboard'}
            className="px-3 py-2 sm:px-4 bg-indigo-600 text-white rounded hover:bg-indigo-700 flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <span className="hidden lg:inline">Adherence</span>
            <span className="lg:hidden">Adhere</span>
          </button>
          <button
            onClick={() => window.location.href = '/patients/summary'}
            className="px-3 py-2 sm:px-4 bg-teal-600 text-white rounded hover:bg-teal-700 flex items-center justify-center gap-2 text-sm sm:text-base col-span-2 sm:col-span-1"
          >
            <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          ...
          <div className="space-y-2 sm:space-y-3">
            {patients.map(patient => (
              <div
                ...
                className="p-3 sm:p-4 border rounded hover:bg-gray-50"
              >
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                  ...
                  >
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">UHID: {patient.uhid}</p>
          ...
          {totalPages > 1 && (
            <div className="mt-4 flex justify-center gap-2 flex-wrap">
              <button
                ...
                className="px-3 sm:px-4 py-2 border rounded disabled:opacity-50 text-sm sm:text-base"
              >
                Previous
              </button>
      ...
      {showAddPatientModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-4 sm:p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Add New Patient</h2>
      ...
      {showDiseaseSelectionModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-lg max-w-2xl w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
            <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Select Disease to Track</h2>
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-lg p-4 sm:p-6">
                    <div className="flex items-center mb-3 sm:mb-4">
                      ...
                      <h2 className="text-base sm:text-xl font-bold text-blue-900">Patient Summary</h2>
                    </div>
                    ...
                    {(() => {
                      ...
                      return recentDiseases.length > 0 ? (
                        <div className="bg-white rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                          <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 sm:mb-3 flex items-center">
                            <svg className="h-4 w-4 sm:h-5 sm:w-5 text-blue-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                          ...
                          <div className="space-y-2">
                            {recentDiseases.slice(0, 5).map((disease, index) => (
                              <div 
                                key={index} 
                                className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-2 sm:p-3 bg-gray-50 rounded hover:bg-gray-100 cursor-pointer transition-colors gap-2"
                                onClick={() => window.location.href = `/symptoms/${disease.symptomId}`}
                              >
                                <div className="flex-1">
                                  <p className="font-medium text-sm sm:text-base text-gray-900">{disease.diseaseName}</p>
                      ...
                      <div className="bg-white rounded-lg p-3 sm:p-4">
                        ...
                        <div className="space-y-2">
                          {selectedPatient.reports.slice(0, 3).map((report) => (
                            <div key={report.reportId} className="flex items-start text-xs sm:text-sm p-2 bg-gray-50 rounded">
                              <div className="flex-1">
                  ...
                  <div className="bg-white rounded-lg border p-3 sm:p-4">
                    <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">Detailed Symptom History</h3>
                    {selectedPatient.symptoms.length === 0 ? (
                      <p className="text-gray-500 text-xs sm:text-sm">No symptoms reported</p>
                    ) : (
                      <div className="space-y-2 sm:space-y-3">
                        {selectedPatient.symptoms.map((symptom) => (
                          <div key={symptom.symptomId} className="border rounded-lg p-3 sm:p-4 bg-gray-50">
                            ...
                            {/* AI Summary Section */}
                            {symptom.aiSummary && (
                              <div className="mb-2 sm:mb-3 p-2 sm:p-3 bg-blue-50 rounded border border-blue-200">
                                <div className="flex items-center gap-2 mb-2">
                                  <svg className="h-4 w-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                  </svg>
                                  <span className="text-xs sm:text-sm font-semibold text-blue-900">AI Clinical Summary</span>
                                </div>
                                <div className="text-xs sm:text-sm text-gray-800 whitespace-pre-line">
                                  {symptom.aiSummary}
                                </div>
                              </div>
                            )}
                            ...
                            <div className="mb-2">
                              ...
                              <p className="text-xs sm:text-sm text-gray-900">{symptom.rawText}</p>
                            </div>
                  ...
                  {selectedPatient.reports.length > 0 && (
                    <div className="bg-white rounded-lg border p-3 sm:p-4">
                      <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">All Medical Reports</h3>
                      <div className="space-y-2 sm:space-y-3">
                        {selectedPatient.reports.map((report) => (
                          <div key={report.reportId} className="border rounded-lg p-2 sm:p-3 bg-gray-50">
                            <p className="text-xs sm:text-sm font-medium mb-1">Report uploaded on {new Date(report.uploadedAt).toLocaleDateString()}</p>
                            {report.summary && report.summary.keyFindings && report.summary.keyFindings.length > 0 && (
                              <div className="mt-2">
